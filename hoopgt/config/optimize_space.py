...
# this ordering determins the order of optimization, modify carefully
...
class OptimizeConfigurationSpace(ConfigurationSpace):
    """
    Wraps the ConfigSpace configuration space object to create the space of all configurations.
...
OPTIMIZE_SPACE = OptimizeConfigurationSpace(name="optimize_config", seed=1234)
